...
urlpatterns = patterns('',
    ...
    url(r'^application/(?P<application_id>[\d]+)/task/', views.task_form_page, name='task_form_page'),
    ...
    url(r'^task/(?P<task_id>[\d]+)/edit/', views.task_form_page, name='task_form_page'),
    url(r'^task/(?P<task_id>[\d]+)/', views.task_page, name='task_page'),
